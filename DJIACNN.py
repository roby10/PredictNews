...
from keras.layers import Conv1D, Dropout, Activation, Embedding, Convolution1D, MaxPooling1D, Input, Dense, BatchNormalization, Flatten, Reshape, Concatenate
...
def main():
	...
	'''
	CNN here
	62% cu 50 embedding 16batch
	64% cu 50 embedding 32batch
	'''
	model = Sequential()
	...
	plot_model(model, to_file='figures/CNN.png', show_shapes=True, show_layer_names=True)

	model.fit(x_train, y_train, batch_size=8, epochs=epochs, validation_split=0.2, verbose=1)
