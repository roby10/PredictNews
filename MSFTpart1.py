...
def main():
	...
	news = pd.read_csv("others/MSFTnew.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("others/MSFTdata.csv", encoding = "utf-8")
	...
	print("------------------MSFT Liniar Regression 1gram--------------------")
	basicvectorizer = CountVectorizer(ngram_range=(1,1))
	#print(news)

	train = news[news['Date'] <= 42680]
	test = news[news['Date'] > 42680]
	...
	#print(counts)
	print("------------------MSFT Liniar Regression 2gram--------------------")
	...
	print("------------------MSFT Random Forest 1gram--------------------")
	...
	print("------------------MSFT Random Forest 2gram--------------------")
