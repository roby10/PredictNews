...
def main():
	...
	news = pd.read_csv("others/GMnew.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("others/GMdata.csv", encoding = "utf-8")
	...
	print("------------------GM Liniar Regression 1gram--------------------")
	basicvectorizer = CountVectorizer(ngram_range=(1,1))
	#print(news)

	train = news[news['Date'] <= 42755]
	test = news[news['Date'] > 42755]
	...
	#print(counts)
	print("------------------GM Liniar Regression 2gram--------------------")
