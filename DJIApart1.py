...
def main():
	...
	print("------------------DJIA Liniar Regression 1gram--------------------")
	...
	#print(counts)
	print("------------------DJIA Liniar Regression 2gram--------------------")
	...
	print("------------------DJIA Random Forest 1gram--------------------")


	basicvectorizer3  = CountVectorizer(ngram_range=(1,1))
	basictrain3 = basicvectorizer3.fit_transform(train.iloc[:,1])
	basicmodel3 = RandomForestClassifier(n_estimators=10, criterion='entropy',max_features='auto')
	...
	print("------------------DJIA Random Forest 2gram--------------------")


	basicvectorizer4  = CountVectorizer(ngram_range=(2,2))
	basictrain4 = basicvectorizer4.fit_transform(train.iloc[:,1])
	basicmodel4 = RandomForestClassifier(n_estimators=10, criterion='entropy',max_features='auto')
