...
def main():
	...
	news = pd.read_csv("others/AAPLnew.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("others/AAPLdata.csv", encoding = "utf-8")
	...
	print("------------------AAPL Liniar Regression 1gram--------------------")
	basicvectorizer = CountVectorizer(ngram_range=(1,1))
	#print(news)

	train = news[news['Date'] <= 42767]
	test = news[news['Date'] > 42767]
	...
	#print(counts)
	print("------------------AAPL Liniar Regression 2gram--------------------")
	...
	print("------------------AAPL Random Forest 1gram--------------------")
	...
	print("------------------AAPL Random Forest 2gram--------------------")
