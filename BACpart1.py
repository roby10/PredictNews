...
def main():
	...
	news = pd.read_csv("others/BACnew.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("others/BACdata.csv", encoding = "utf-8")
	...
	print("------------------BAC Liniar Regression 1gram--------------------")
	basicvectorizer = CountVectorizer(ngram_range=(1,1))
	#print(news)

	train = news[news['Date'] <= 42580]
	test = news[news['Date'] > 42580]
	...
	#print(counts)
	print("------------------BAC Liniar Regression 2gram--------------------")
