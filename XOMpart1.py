...
def main():
	...
	news = pd.read_csv("others/XOMnew.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("others/XOMdata.csv", encoding = "utf-8")
	...
	train = news[news['Date'] <= 42850]
	test = news[news['Date'] > 42850]
