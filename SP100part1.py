...
def main():
	...
	news = pd.read_csv("SP100/SP100news.csv" , encoding = "utf-8",header=None)
	data = pd.read_csv("SP100/SP100data.csv", encoding = "utf-8")
	...
	print("------------------SP100 Liniar Regression 1gram--------------------")
	...
	#print(counts)
	print("------------------SP100 Liniar Regression 2gram--------------------")
	...
	print("------------------SP100 Random Forest 1gram--------------------")
	...
	print("------------------SP100 Random Forest 2gram--------------------")
